...
#ifndef MAGICTRAVEL_SWIFT_H
#define MAGICTRAVEL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MagicTravel",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11MagicTravel11AppDelegate")
...
SWIFT_CLASS("_TtC11MagicTravel13SceneDelegate")
...
SWIFT_CLASS("_TtC11MagicTravel14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, strong) IBOutlet UITableView * _Null_unspecified citiesTableView;
- (void)viewDidLoad;
...
@interface ViewController (SWIFT_EXTENSION(MagicTravel)) <UITableViewDelegate>
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end

@class UITableViewCell;

@interface ViewController (SWIFT_EXTENSION(MagicTravel)) <UITableViewDataSource>
